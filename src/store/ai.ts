    ...
    try {
      ...
      if (file?.aiSettings) {
        ...
        const settings: AISettings = {
          ...
          ttsProvider: file.aiSettings.ttsProvider ?? 'minimax',
          ...
          edgeTtsVoice: file.aiSettings.edgeTtsVoice ?? 'zh-CN-XiaoxiaoNeural',
    ...
    if (rawValue) {
      try {
        ...
        const raw: AISettings = {
          ...
          ttsProvider: parsed.ttsProvider ?? 'minimax',
          ...
          edgeTtsVoice: parsed.edgeTtsVoice ?? 'zh-CN-XiaoxiaoNeural',
